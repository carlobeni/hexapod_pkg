...
def generate_launch_description():
    ...
    # FOLLOWER NODES
    # =================================================
    ball_viewer_yolo_follower = Node(
        package=package_name,
        executable="ball_viewer_yolo_follower.py",
        name="ball_viewer_yolo_follower",
        output="screen",
        parameters=[{
    ...
    follower_navigation_node = Node(
        package=package_name,
        executable="follower_navigation_node.py",
        name="follower_navigation_node",
        output="screen",
        parameters=[{

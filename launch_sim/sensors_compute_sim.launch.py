...
def generate_launch_description():
    ...
    compute_gps_to_local_xy = Node(
        ...
        parameters=[{
            ...
            "LAT0": cfg.LAT_REFERENCE,  # Lat reference
            "LON0": cfg.LON_REFERENCE   # Lon reference
        }],
    )
    ...
    compute_estimate_xy = Node(
        ...
        parameters=[{
            ...
            "linear_v": 0.05,
            "lateral_v": 0.002,
            "dead_reckoning_weight":0,  # Between 0 and 1, if is 0 only GPS data and if is 1 only odom data
